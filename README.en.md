...
| `STORAGE_ORPHAN_GRACE_HOURS` | `168` | Grace period (hours, 7 days by default) before an attachment can count as an orphan: a file just uploaded but not yet sent, or an artifact still being generated, is “temporarily unreferenced” and must not be reclaimed |
