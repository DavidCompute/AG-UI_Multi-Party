...
{
    Console.Error.WriteLine("用法: AguiGroupChat.NativeBridge --tunnel <Hub基址> --tunnel-token <隧道令牌> [--agent <数字员工id>]");
...
var tunnel = new NativeTunnelClient(tunnelHub, string.IsNullOrWhiteSpace(tunnelAgent) ? "*" : tunnelAgent, tunnelToken);
