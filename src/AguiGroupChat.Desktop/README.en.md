...
A pure desktop application (Windows) **(current version 1.0.136)**: it reuses all the features of the web version (group chat, agents, human-in-the-loop approval, semantic memory RAG,
...
Current version: **1.0.136** (see `<Version>` in `src/AguiGroupChat.Desktop/AguiGroupChat.Desktop.csproj`).
...
#     → artifacts/wix/AguiGroupChat-Desktop-1.0.136.msi
```
