...
Current version: **1.0.120** (see `<Version>` in `src/AguiGroupChat.Desktop/AguiGroupChat.Desktop.csproj`).
...
#    e.g. for 1.0.120:
powershell -ExecutionPolicy Bypass -File tools/build-msi.ps1 -Version 1.0.120
#     → artifacts/wix/AguiGroupChat-Desktop-1.0.120.msi
```
