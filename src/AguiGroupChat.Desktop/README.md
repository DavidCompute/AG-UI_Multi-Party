...
纯桌面应用（Windows）**（当前版本 1.0.121）**：复用 Web 版全部功能（群聊、智能体、人机交互审批、语义记忆 RAG、
个人记忆、AI 分身、附件、话题、触发方式、记忆拟人类型等），但**数据与模型全部在本机**；服务在本机固定起在
...
当前版本：**1.0.121**（见 `src/AguiGroupChat.Desktop/AguiGroupChat.Desktop.csproj` 的 `<Version>`）。
