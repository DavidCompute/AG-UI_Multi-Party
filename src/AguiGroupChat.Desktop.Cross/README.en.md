...
Linux uses WebKitGTK. Current version **1.0.116** (see `src/AguiGroupChat.Desktop.Cross/AguiGroupChat.Desktop.Cross.csproj`). Features match the Windows version (`src/AguiGroupChat.Desktop`); both share
